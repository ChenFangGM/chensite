...
angular.module("galleryApp").controller("portfolioController", portfolioController), 
...
}), angular.module("angular-timeline", []), angular.module("todoService", []).factory("Todos", function(a) {
    return {
        get: function() {
...
var unityObject = {
    ...
    var W = function() {
        ...
        handlePluginStatus: function(a) {
            var b = V.targetEl, c = jQuery(b);
            switch (a) {
              case L:
                this.notifyProgress(c), this.embedPlugin(c, V.callback);
                break;

              case M:
                this.notifyProgress(c);
                var d = this, e = 0 === V.debugLevel ? 1e3 : 8e3;
                setTimeout(function() {
                    V.targetEl = b, d.detectUnity(d.handlePluginStatus);
                }, e);
                break;
        ...
        notifyProgress: function() {
            if ("undefined" != typeof E && "function" == typeof E) {
                ...
                J === M && (a.bestMethod = this.getBestInstallMethod()), H !== J && (H = J, E(a));
            }
        },
...
UnityObject2.instances = [], $(function() {
    if ($(window).width() > 640) {
        var a = $("header").height();
        $(document).scroll(function() {
            var b = $(document).scrollTop(), c = parseInt(b * -.1) + "px", d = b / a * .4;
            $(".chen").css("margin-top", c), $("header").css("background", "rgba(0,0,0," + d);
        });
    }
});
...
jQuery(function() {
    var a = jQuery("#unityPlayer").find(".missing"), b = jQuery("#unityPlayer").find(".broken");
    a.hide(), b.hide(), u.observeProgress(function(c) {
        switch (c.pluginStatus) {
          case "broken":
            b.find("a").click(function(a) {
                return a.stopPropagation(), a.preventDefault(), u.installPlugin(), !1;
            }), b.show();
            break;
...
"https:" == document.location.protocol && (unityObjectUrl = unityObjectUrl.replace("http://", "https://ssl-")), 
