/*
 www.chen-fang.com 2015-05-04 
*/
"use strict";

define([ "./indexPage-controller", "./portfolio-controller", "./profile-controller", "./signup-controller", "./login-controller" ], function() {}), 
define([ "angular" ], function(a) {
    ...
    a.controller("indexPageController", function(a, b, c, d) {
        b.currentUser || d.currentUser(function(a) {}), a.logout = function() {
            d.logout(function(a) {
                a || c.go("home");
            });
        };
    ...
    a.controller("loginController", function(a, b, c) {
        a.error = {}, a.user = {}, a.login = function(d) {
            b.login({
                email: a.user.email,
                password: a.user.password
            }, function(b) {
                a.errors = {}, b ? (angular.forEach(b.errors, function(b, c) {
                    if (c.indexOf(".") > -1) {
                        var e = c.split(".");
                        d[e[1]].$setValidity("mongoose", !1), a.errors[e[1]] = b.message;
                    } else d[c].$setValidity("mongoose", !1), a.errors[c] = b.message;
                }), a.error.other = b.message) : (a.$close(), c.go("home"));
            });
        };
    });
...
define([ "angular" ], function(a) {
    ...
    a.factory("Auth", function(a, b, c) {
        return {
            createUser: function(b, d) {
                var e = d || angular.noop;
                c.save(b, function(b) {
            ...
            currentUser: function(c) {
                var d = c || angular.noop;
                b.get(function(b) {
                    return a.currentUser = b, d();
                }, function(a) {
                    return d(a.data);
                });
            },
...
UnityObject2.instances = [], function(a, b, c, d, e, f, g) {
