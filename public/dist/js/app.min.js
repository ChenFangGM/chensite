/*
 www.chen-fang.com 2015-04-16 
*/
"use strict";

define([ "./portfolio-controller", "./profile-controller", "./signup-controller" ], function() {}), 
...
define([ "./controller-manager", "jquery" ], function(a) {
    ...
    a.controller("profileController", function(a, b) {
        a.userinfo = b.currentUser, console.log(a.userinfo._id, a.userinfo.email);
    });
}), define([ "./controller-manager" ], function(a) {
    a.controller("signupController", function(a, b, c) {
        a.register = function(d) {
            c.createUser({
                ...
                a.errors = {}, c ? angular.forEach(c.errors, function(b, c) {
                    d[c].$setValidity("mongoose", !1), a.errors[c] = b.type;
                }) : (a.modalInstance.dismiss("cancel"), b.go("profile"));
            });
        };
    });
...
define([ "angular" ], function(a) {
    ...
    a.constant("focusConfig", {
        ...
        return {
            ...
            link: function(b, c, d, e) {
                e.$focused = !1, c.bind("focus", function() {
    ...
    a.factory("Auth", function(a, b, c, d) {
        return a.currentUser = b.get("user") || null, b.remove("user"), {
            ...
            createUser: function(b, c) {
                var e = c || angular.noop;
                d.save(b, function(b) {
                    return a.currentUser = b, e();
                }, function(a) {
                    return e(a.data);
                });
            },
    ...
    a(function() {
        if (a(window).width() > 640) {
            ...
            a(document).scroll(function() {
                var c = a(document).scrollTop(), d = parseInt(c * -.1) + "px", e = c / b * .4;
                a(".chen").css("margin-top", d), a("header").css("background", "rgba(0,0,0," + e);
            });
        }
    });
});