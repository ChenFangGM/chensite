...
define([ "./controller-manager" ], function(a) {
    a.controller("indexPageController", function(a, b, c, d, e) {
        e.currentUser(), a.logout = function() {
            e.logout(function(a) {
                a || d.go("home");
            });
        };
    ...
    a.controller("loginController", function(a, b, c) {
        a.error = {}, a.user = {}, a.login = function(d) {
            b.login("password", {
                ...
                a.errors = {}, angular.forEach(b.errors, function(b, c) {
                    d[c].$setValidity("mongoose", !1), a.errors[c] = b.type;
                }), a.error.other = b.message;
            }, function() {
                a.errors = {}, a.$close(), c.go("home");
            });
        };
    });
    ...
    a.controller("signupController", function(a, b, c, d) {
        a.register = function(b) {
            d.createUser({
                ...
                a.errors = {}, angular.forEach(c.errors, function(c, d) {
...
define([ "angular" ], function(a) {
    ...
    a.factory("Auth", function(a, b, c, d) {
        return a.currentUser = b.get("user") || null, b.remove("user"), {
            login: function(b, d, e, f) {
                var g = e || angular.noop, h = f || angular.noop;
                c.save({
                    provider: b,
                    email: d.email,
                    password: d.password
                }, function(b) {
                    return a.currentUser = b, h();
                }, function(a) {
                    return g(a.data);
                });
            },
            ...
            createUser: function(b, c, e) {
                var f = c || angular.noop, g = e || angular.noop;
                d.save(b, function(b) {
                    return a.currentUser = b, g();
                }, function(a) {
                    return f(a.data);
                });
            },
